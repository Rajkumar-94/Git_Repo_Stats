...
def lambda_handler(event,context):
    ...
    with open(lambda_temp_file,'a+',newline='') as f:
        ...
        for repository in repositories:
            ...
            clone_dict,clone_count,unique_clone_count = get_repo_clone(today_date,github_obj,repository)
            visitors_dict,view_count,unique_visitors = get_repo_views(today_date,github_obj,repository)
...
def get_repo_clone(today_date,github_obj,repository):
...
def get_repo_views(today_date,github_obj,repository):
